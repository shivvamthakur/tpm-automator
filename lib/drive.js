 ...
 */
async function uploadPDFToDrive(auth, fileName, pdfBuffer, existingFileId = null) {
 ...
 */
async function createSlackDoc(auth, fileName, slackContent, existingFileId = null) {
    const drive = google.drive({ version: 'v3', auth });
